  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        ...
        line="OutputBaseFilename=Fz10m Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Fz10m Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Fz10m installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Fz10m Demo installer\n"
     else:
       line="SetupWindowTitle=Fz10m installer\n"
