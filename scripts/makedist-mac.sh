...
NOTARIZE_BUNDLE_ID=com.Grovepark.Fz10m
NOTARIZE_BUNDLE_ID_DEMO=com.Grovepark.Fz10m.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Fz10m.iss
#  git checkout installer/Fz10m.pkgproj
